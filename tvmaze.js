...
var ALT_IMG = "https://store-images.s-microsoft.com/image/apps.65316.13510798887490672.6e1ebb25-96c8-4504-b714-1f7cbca3c5ad.f9514a23-1eb8-4916-a18e-99b1a9817d15?mode=scale&q=90&h=300&w=300";
...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var response, showsFromAPI, shows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(BASE_URL, "search/shows?q=").concat(term))];
                case 1:
                    response = _a.sent();
                    showsFromAPI = response.data;
                    shows = showsFromAPI.map(function (s) { return ({
                        id: s.show.id,
                        name: s.show.name,
...
function populateEpisodes(episodes) {
    ...
    for (var _i = 0, episodes_1 = episodes; _i < episodes_1.length; _i++) {
        var e = episodes_1[_i];
        var $e = $("<li id=\"".concat(e.id, "\">").concat(e.name, " (season: ").concat(e.season, ", episode: ").concat(e.number, ")</li>"));
